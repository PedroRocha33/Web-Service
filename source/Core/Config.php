...
$CONF_DB_NAME = "db_webservice";
$CONF_DB_USER = "root";
$CONF_DB_PASSWORD = "";

//$conexao = new mysqli($CONF_DB_HOST, $CONF_DB_NAME, $CONF_DB_USER, $CONF_DB_PASSWORD);

const CONF_URL_BASE = "http://localhost/Web-Service"; // URL base do site

/*
 * Configuração de variáveis para upload de arquivos e imagens.
 */
